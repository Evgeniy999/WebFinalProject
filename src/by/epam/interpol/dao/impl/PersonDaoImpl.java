...
public class PersonDaoImpl implements PersonDao {
    ...
    private static final String SEARCH_PERSON_BY_ID = "SELECT * FROM people JOIN type_statement on people.person_status=type_statement.statement_id  WHERE document_id = ?";
