...
<div class="container">
    ...
    <p></p>
    <h4>INTERPOL border security training supports female ASEAN officers</h4>
    <div class="contect_news">
        ...
        trafficking and migrant smuggling in Southeast Asia, INTERPOL conducted a training course to enhance border
    ...
    <h4>Drugs worth USD 360 million seized in INTERPOL-led operation</h4>
    <div class="contect_news">
        SINGAPORE – Illegal drugs worth an estimated USD 360 million were seized across the Asia-Pacific and Middle East
        regions in an INTERPOL-coordinated operation.Targeting illicit drug trafficking, Operation Lionfish –
    ...
    <h4> INTERPOL launches initiative to boost African security</h4>
    <div class="contect_news">
        SINGAPORE – Enhancing cooperation between law enforcement agencies against terror suspects and criminals
        travelling across Southeast Asia was the focus of a border operation conducted as part of INTERPOL’s Project
    ...
    <h4>Suspected terrorist among 17 arrested during INTERPOL operation in Southeast Asia</h4>
    <div class="contect_news">
        LYON, France– Tackling human trafficking and strengthening borders in the West Africa
        – Sahel region was the
        focus of
        two INTERPOL training sessions in Mauritania and Senegal.The capacity building events (21 - 29 August 2017)
        aimed to
    ...
    <div class="contect_news">
        ...
        INTERPOL-Europol operation targeting
        fake food
    ...
    <h4> More than 4,100 arrests in INTERPOL-led operation targeting Asian illegal gambling networks</h4>
    <div class="contect_news">
        BANGKOK, Thailand - More than 4,100 people have been arrested and USD 13.6 million seized in two INTERPOL-led
